...
public class WorkerPageController {
    @RequestMapping(value = "/workerPage", method = {RequestMethod.POST, RequestMethod.GET})
    public @ResponseBody
    String main(HttpSession session) {
        String order="<!DOCTYPE html>\n" +
                ...
                "                                <li class=\"mbr-navbar__item\"><a class=\"mbr-buttons__link btn text-white\" href=\"#/Ships\">Ships</a></li>\n" +
                "                                <li class=\"mbr-navbar__item\"><a class=\"mbr-buttons__link btn text-white\" href=\"#/Workers\">";
                order = order.concat("Users");
                order = order.concat("</a></li>\n" +
                "                                <li class=\"mbr-navbar__item\"><a class=\"mbr-buttons__link btn text-white\" href=\"#/Flights\">Flights</a></li>\n");
                if(session.getAttribute("ROLE_ADMIN")!=null)order = order.concat("<li class=\"mbr-navbar__item\"><a class=\"mbr-buttons__link btn text-white\" href=\"#/atmosphere\">Atmosphere config</a></li>\n" +
                        "<li class=\"mbr-navbar__item\"><a class=\"mbr-buttons__link btn text-white\" href=\"#/planet\">Planets config</a></li>\n");
                ...
                "                            <ul class=\"mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active\"><li class=\"mbr-navbar__item\"><a class=\"mbr-buttons__btn btn btn-danger\" ");
                        order = order.concat("href=\"#/logout\">Log Out</a></li></ul>\n");
                order = order.concat("                        </div>\n" +
                "                    </nav>\n" +
                "                </div>\n" +
                "            </div>\n" +
                "        </div>\n" +
